...
<div class="modal fade" id="profile">
  <div class="modal-dialog">
      ...
      <div class="modal-body">
        ...
        <form class="form-horizontal" method="POST" action="profile_update.php?return=<?php echo basename($_SERVER['PHP_SELF']); ?>" enctype="multipart/form-data">
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-10">
              <input type="text" class="form-control" id="tel" name="tel" value="<?php echo $supplier['tel']; ?>">
            </div>
          </div>
          <div class="form-group row">
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-10">
              <input type="text" class="form-control" id="shopName" name="shopName" value="<?php echo $supplier['shopName']; ?>">
    ...
    <div class="form-group row">
      ...
      <div class="col-sm-10">
        <textarea class="form-control" id="address" name="description" value="<?php echo $supplier['description']; ?>"><?php echo $supplier['description']; ?></textarea>
      </div>
    </div>

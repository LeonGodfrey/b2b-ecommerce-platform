  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Feedback about orders from clients!</h1>
          </div>
          <div class="col-sm-6">
                ...
                <tbody>
                  <?php
                    ...
                    try{
                      ...
                      $stmt = $conn->prepare("SELECT * from orders left join sme on orders.userIdS = sme.userIdS where orders.userIdD= :id AND orders.status = :status AND orders.feedback IS NOT NULL");

                      ...
                      foreach($stmt as $row){
                        ...
                        echo "
                          <tr>
                            ...
                            <td>".$row['address']."</td>                          
                            <td>
                              <button class='btn btn-success btn-sm edit btn-flat' data-id='".$row['userIdD']."'><i class='fa fa-edit'></i> Edit</button>
                              <button class='btn btn-danger btn-sm delete btn-flat' data-id='".$row['UserIdD']."'><i class='fa fa-trash'></i> Delete</button>
                            </td>
                          </tr>
                        ";
                      }
